...
export const getUserStats = async () => {
  ...
  const response = await axios({
    method: 'GET',
    url: 'https://dask-expense-tracker-api.herokuapp.com/api/v1/transaction/total_inc_exp_bal',
    headers: {
...
export const login = async (formData) => {
  ...
  const response = await axios({
    method: 'POST',
    url: 'https://dask-expense-tracker-api.herokuapp.com/api/v1/auth/login',
    data: formData,
  });
...
export const register = async (formData) => {
  const response = await axios({
    method: 'POST',
    url: 'https://dask-expense-tracker-api.herokuapp.com/api/v1/users',
    data: formData
  })
...
export const getAllPosts = async () => {
  const response = await axios({
    method: 'GET',
    url: 'https://dask-expense-tracker-api.herokuapp.com/api/v1/post/all'
  });
...
export const postPost = async (formData) => {
  ...
  const response = await axios({
    method: 'POST',
    url: 'https://dask-expense-tracker-api.herokuapp.com/api/v1/post',
    data: formData,
    headers: {
      'Authorization': `Bearer ${token}`
    }
...
export const getUsersTransaction = async () => {
  ...
  const response = await axios({
    method: 'GET',
    url: 'https://dask-expense-tracker-api.herokuapp.com/api/v1/transaction',
    headers: {
      'Authorization': `Bearer ${token}`
    }
  })
...
export const updateUserAvatar = async (formData) => {
  ...
  const response = await axios({
    method: 'PATCH',
    url: 'https://dask-expense-tracker-api.herokuapp.com/api/v1/users/avatar',
    data: formData,
    headers: {
      'Authorization': `Bearer ${token}`
    }
...
export const udpatePassword = async (formData) => {
  ...
  const response = await axios({
    method: 'PATCH',
    url: 'https://dask-expense-tracker-api.herokuapp.com/api/v1/users/password',
    data: formData,
    headers: {
      'Authorization': `Bearer ${token}`
    }
...
export const likePost = async (postId) => {
  ...
  const response = await axios({
    method: 'POST',
    url: `https://dask-expense-tracker-api.herokuapp.com/api/v1/post/like/${postId}`,
    headers: {
      'Authorization': `Bearer ${token}`
    },
  })
...
export const expensesByCategory = async () => {
  ...
  const response = await axios({
    method: 'GET',
    url: 'https://dask-expense-tracker-api.herokuapp.com/api/v1/transaction/expenses_by_category',
    headers: {
      'Authorization': `Bearer ${token}`
    }
  })
